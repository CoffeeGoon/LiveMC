...
musicanaccount.addEventListener("click", function(e){
  clicked = "band";
	var url = "http://lmc.konghexdev.x10host.com/bandpasscheck.php?callback=?&user=" + document.getElementById("usr").value;
	$.getJSON(url, callbac);
...
venueaccount.addEventListener("click", function(e){
  clicked = "venue";
var url = "http://lmc.konghexdev.x10host.com/hostpasscheck.php?callback=?&user=" + document.getElementById("usr").value;
$.getJSON(url, callbac);
}
);
