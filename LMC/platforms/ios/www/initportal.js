 ...
 $("#bioinput").hide();
  ...
  //$('#Item0').click(alert(users[0]));
      ...
      $('#req').click(function(){
        ...
        $('#lis').append( "<li data-role='list-divider'> <img src='img/exx.jpg' onClick='del(" + i + ")'> </img>   </li> <li data-role='list-divider'>"  +  decodeURIComponent(k.requests[i]) + " </li>").listview("refresh");
      }
